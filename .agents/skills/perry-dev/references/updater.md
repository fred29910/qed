<!-- Perry docs bundle: updater.md -->
<!-- Canonical online source: https://docs.perryts.com/ -->

<!-- source: docs/src/updater/overview.md -->
...
- [System APIs](https://docs.perryts.com/system/overview.html) — the rest of `perry/system`
- [HTTP & Networking](https://docs.perryts.com/stdlib/http.html) — `fetch()` is what the wrapper
  uses internally
- [Cryptography](https://docs.perryts.com/stdlib/crypto.html) — Ed25519 sign / verify primitives
