<!-- Perry docs bundle: cli-config.md -->
<!-- Canonical online source: https://docs.perryts.com/ -->

<!-- source: docs/src/cli/perry-toml.md -->
...
Internationalization configuration. See the [i18n documentation](https://docs.perryts.com/i18n/overview.html) for full details.
